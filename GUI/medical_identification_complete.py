...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.identification_text.setGeometry(QtCore.QRect(90, 30, 64, 15))
        ...
        self.face_text1.setGeometry(QtCore.QRect(240, 20, 311, 71))
        ...
        self.record_image.setStyleSheet("border-image: url('/home/pi/myproject/myenv/PyQT_final/record.png');")
        self.record_image.setText("")
        self.record_image.setObjectName("record_image")

        self.face_text2 = QtWidgets.QLabel(Dialog)
        self.face_text2.setGeometry(QtCore.QRect(220, 120, 401, 71))
        ...
        self.navigation_image.setStyleSheet("border-image: url('/home/pi/myproject/myenv/PyQT_final/home.png');")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.identification_text.setText(_translate("Dialog", "신원 확인"))
        self.medical_text.setText(_translate("Dialog", "환자"))
        self.face_text1.setText(_translate("Dialog", "신원 확인이 완료되었습니다."))
        self.face_text2.setText(_translate("Dialog", "배송하려는 의약품을 말씀해주세요."))
...
class RecordHandler:
    ...
    def start_voice_prompt(self):
        try:
            engine = pyttsx3.init()
            PROMPT1 = "신원 확인이 완료되었습니다."
            PROMPT2 = "배송하려는 의약품을 말씀해주세요."
            engine.say(PROMPT1)
            engine.say(PROMPT2)
            engine.runAndWait()
    ...
    def record_audio_and_process(self):
        ...
        TARGET_WORDS = ["플루이드", "니들", "시린지", "켈리", "시저", "메스"]
        ...
        if any(preprocess_text(word) in recognized_text for word in TARGET_WORDS):
            self.parent.recording_complete.emit("recognized")
        else:
            self.parent.recording_complete.emit("not recognized")


class IdentificationCompleteWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.recording_complete.connect(self.handle_recording_result)

    def showEvent(self, event):
        super(IdentificationCompleteWidget, self).showEvent(event)
    ...
    def handle_recording_result(self, result):
    ...
    #def handle_recording_result(self, result):
        #self.recording_complete.emit(result)
...
if __name__ == "__main__":
    ...
    widget = IdentificationCompleteWidget()
