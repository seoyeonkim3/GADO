...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.map.setStyleSheet("#map{border-image:url(:/map/imaging.png)}")
        self.map.setText("")
        self.map.setObjectName("map")
        self.verticalLayoutWidget = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(130, 350, 722, 80))
        ...
        self.map_text4 = QtWidgets.QLabel(self.verticalLayoutWidget)  # Corrected here
        self.map_text4.setObjectName("map_text4")
        self.verticalLayout.addWidget(self.map_text4)
        self.map_text1 = QtWidgets.QLabel(Dialog)
        self.map_text1.setGeometry(QtCore.QRect(120, 10, 121, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.map_text3.setText(_translate("Dialog", "접수 수납 구역을 지나간 다음 왼쪽의 벽을 중심으로 반시계 방향으로 돌며 방향을 전환합니다."))
        self.map_text4.setText(_translate("Dialog", "화장실을 마주보는 방향에서 오른쪽으로 꺾어 계속 직진하면 영상의학과에 도착합니다."))
        self.map_text1.setText(_translate("Dialog", "영상 의학과"))

class ImagingMapWidget(QWidget, Ui_Dialog):
